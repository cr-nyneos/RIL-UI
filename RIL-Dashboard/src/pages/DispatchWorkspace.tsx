      ...
      <div className="space-y-8 pb-24">
        ...
        <GlassCard bloom="info" className="animate-rise p-5" style={{ animationDelay: '60ms' }}>
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <div className="text-section-title">Dispatch Readiness</div>
              <div className="mt-1 text-meta">Capture logistics, transport and documents before execution begins. {completedCount} of {STEPS.length} steps completed.</div>
            </div>
